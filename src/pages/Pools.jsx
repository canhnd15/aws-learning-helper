...
export default function Pools() {
  ...
  const items =
    poolType === 'section' ? sections :
    poolType === 'topic' ? topics : tests
  const itemsLoading =
    poolType === 'section' ? sectionsLoading :
    poolType === 'topic' ? topicsLoading : testsLoading
  const sidebarTitle =
    poolType === 'section' ? 'Sections' :
    poolType === 'topic' ? 'Topics' : 'Tests'
        ...
        <main className="pool-main">
          ...
          {notesLoading ? (
            ...
            <div className="empty-state">
              <p>No notes found.</p>
              {selectedId && <p>Try selecting a different pool or clearing your search.</p>}
            </div>
          ) : (
